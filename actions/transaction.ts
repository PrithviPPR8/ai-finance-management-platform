...
import { GoogleGenAI } from "@google/genai"; // Correct import for the new SDK
...
export async function createTransaction(data: any) {
  try {
    if (!data || typeof data !== "object" || !data.accountId) {
      throw new Error("Invalid input: 'accountId' is required in data");
    }
...
function calculateNextRecurringDate(startDate: Date, interval: any) {
